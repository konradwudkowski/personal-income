...
case class IncomeTaxViewModel(
                               estimatedIncomeTax:BigDecimal = 0,
                               ...
                               simpleTaxUser: Boolean
                             )

object IncomeTaxViewModel {
  implicit val format = Json.format[IncomeTaxViewModel]
}
